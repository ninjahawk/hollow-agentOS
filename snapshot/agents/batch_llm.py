...
# ── Server ───────────────────────────────────────────────────────────────────
    ...
    # +mass injection hookclass BatchLLMServer:
    # +mass injection hook    """
    # +mass injection hook    Singleton batch inference server.
    # +mass injection hook    Call generate(prompt) from any thread — it blocks until the next
    # +mass injection hook    batch fires and returns the model's response string.
    # +mass injection hook    """
    # +mass injection hook
    def __init__(self):
        self._model = None
